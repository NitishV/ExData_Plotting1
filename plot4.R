...
plot(house.power$Date_Time, house.power$Global_active_power, type='l', xlab='', ylab='Global Active Power', cex.lab=0.7)
plot(house.power$Date_Time, house.power$Voltage, type='l', xlab='datetime', ylab='Voltage', cex.lab=0.7)
...
legend('topright', legend = c('Sub_metering_1', 'Sub_metering_2', 'Sub_metering_3'), col = c('black', 'red', 'blue'), bty='n', lty=1, cex=0.7, text.width = 86000)
plot(house.power$Date_Time, house.power$Global_reactive_power, xlab='datetime', ylab='Global_reactive_power', type='l', cex.lab=0.7)
